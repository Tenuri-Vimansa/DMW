...
if (isset($_GET['ajax']) && $_GET['ajax'] == 1) {
    ...
    $sql = "SELECT COUNT(*) AS total FROM doc_anderson WHERE Date = '$date'";
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO doc_anderson (Patient_Name, Age, Gender, Symptoms, Date, Ap_No) VALUES (?, ?, ?, ?, ?, ?)");
