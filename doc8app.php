...
if (isset($_GET['ajax']) && $_GET['ajax'] == 1) {
    ...
    $sql = "SELECT COUNT(*) AS total FROM dr_arendria WHERE Date = '$date'";
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO dr_arendria (Patient_Name, Age, Gender, Symptoms, Date, Ap_No) VALUES (?, ?, ?, ?, ?, ?)");
